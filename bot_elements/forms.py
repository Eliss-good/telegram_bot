...
send_forms_mem = [] # [{'form_id': *form_id*, 'info': {'form_creator_user_id': id,'send_to_users_ids': [ids]}, ... ]

# temp_mem_for_form_creator + temp_poll_recip_data -> mem_for_created_forms -> send_forms_mem -> zames
