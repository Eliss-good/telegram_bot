...
def send_forms_mem_get_form(sent_form_id: int):
    ...
    #return con_db.get_data_form('one', form_id=send_forms_mem)
...
def get_all_groups():
    return con_db.list_all_data('group')


def get_group_users_ids(groups: list):
    return con_db.find_us_for_survay([groups])
