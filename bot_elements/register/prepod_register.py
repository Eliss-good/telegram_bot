...
from bot_elements.getter.all_getters import registerData_get_fio, registerData_get_role, registerData_check_is_registered, edited_register_data_get_fio, registerData_check_is_confirmed, get_all_groups
